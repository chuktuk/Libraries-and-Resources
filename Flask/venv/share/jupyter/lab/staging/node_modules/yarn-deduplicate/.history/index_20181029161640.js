...
module.exports.listDuplicates = (yarnLock, {
    ...
    getDuplicatedPackages(json, {includePackages, useMostCommon}).forEach(({bestVersion, name, installedVersion, requestedVersion}) => {
...
module.exports.fixDuplicates = (yarnLock, {
    ...
    const json = parseYarnLock(yarnLock, {includePackages, useMostCommon});

    getDuplicatedPackages(json).forEach(({bestVersion, name, installedVersion, requestedVersion}) => {
