...
module.exports.listDuplicates = (yarnLock, {
    ...
    Object.keys(packages)
        ...
        .forEach(packageInstance => {
            const {bestVersion, name, pkg, requestedVersion} = packageInstance;
            if (bestVersion !== pkg.version) {
                result.push(`Package "${name}" wants ${requestedVersion} and could get ${bestVersion}, but got ${pkg.version}`);
            }
        });
