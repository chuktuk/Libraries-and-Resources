...
module.exports.listDuplicates = (yarnLock, {
    ...
    getPackages(json).forEach({bestVersion, name, installedVersion, requestedVersion} => {
...
module.exports.fixDuplicates = (yarnLock, {
    ...
    getPackages(json).forEach(packageInstance => {
        const {bestVersion, name, installedVersion, requestedVersion, versions} = packageInstance;
        if (bestVersion !== installedVersion) {
