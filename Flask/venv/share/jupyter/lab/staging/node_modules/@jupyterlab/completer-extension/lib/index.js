...
import { CompleterModel, Completer, CompletionConnector, CompletionHandler, ContextConnector, ICompletionManager } from '@jupyterlab/completer';
...
const consoles = {
    ...
    activate: (app, manager, consoles) => {
        ...
        consoles.widgetAdded.connect((sender, widget) => {
            ...
            const editor = (_b = (_a = anchor.promptCell) === null || _a === void 0 ? void 0 : _a.editor, (_b !== null && _b !== void 0 ? _b : null));
...
const notebooks = {
    ...
    activate: (app, manager, notebooks) => {
        ...
        notebooks.widgetAdded.connect((sender, panel) => {
            var _a, _b;
            const editor = (_b = (_a = panel.content.activeCell) === null || _a === void 0 ? void 0 : _a.editor, (_b !== null && _b !== void 0 ? _b : null));
