 ...
 */
function activate(app, settingRegistry, palette, launcher, restorer, mainMenu, themeManager, runningSessionManagers) {
    var _a;
    ...
    // properties.
    (_a = themeManager) === null || _a === void 0 ? void 0 : _a.themeChanged.connect((sender, args) => {
 ...
 */
function addRunningSessionManager(managers, app) {
