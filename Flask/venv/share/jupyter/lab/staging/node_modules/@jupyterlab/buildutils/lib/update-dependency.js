...
async function getSpecifier(currentSpecifier, suggestedSpecifier) {
    ...
    // references a tag
    let [, suggestedSigil, suggestedTag] = (_a = suggestedSpecifier.match(SEMVER_RANGE), (_a !== null && _a !== void 0 ? _a : []));
    if (!suggestedTag) {
...
function subset(range1, range2) {
    var _a, _b;
    try {
        const [, r1, version1] = (_a = range1.match(SEMVER_RANGE), (_a !== null && _a !== void 0 ? _a : []));
        const [, r2] = (_b = range2.match(SEMVER_RANGE), (_b !== null && _b !== void 0 ? _b : []));
        return (['', '>=', '=', '~', '^'].includes(r1) &&
            r1 === r2 &&
