...
const plugin = {
    ...
    provides: IMainMenu,
    activate: (app, router, palette, labShell) => {
        const { commands } = app;
 ...
 */
export function createEditMenu(app, menu) {
 ...
 */
export function createFileMenu(app, menu, router) {
    const commands = menu.menu.commands;
 ...
 */
export function createKernelMenu(app, menu) {
    const commands = menu.menu.commands;
 ...
 */
export function createViewMenu(app, menu) {
    const commands = menu.menu.commands;
 ...
 */
export function createRunMenu(app, menu) {
    const commands = menu.menu.commands;
 ...
 */
export function createSettingsMenu(_, menu) {
    menu.addGroup([{ command: 'settingeditor:open' }], 1000);
}
/**
 * Create the basic `Tabs` menu.
 */
export function createTabsMenu(app, menu, labShell) {
